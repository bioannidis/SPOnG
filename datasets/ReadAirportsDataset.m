...
classdef ReadAirportsDataset < ReadDataset
	
	
	properties(Constant)
		ch_folderName = 'libGF/datasets/AirportsDataset/';
		ch_cacheFileName = [ReadAirportsDataset.ch_folderName 'CVCache.mat'];
	end
	...
	methods(Static)
		...
		function [comDepCell, comArrCell, comAdjCell] = get6monthData
			folder = ReadAirportsDataset.ch_folderName;
